...
from src.shared.shared import Direction, DirectionsAssignment, SymbolType, symbols_short_in
from src.tools.analysis import get_clusters_consecutive_integers
